...
const Form = ({ onClose, onSwitchToSignUp }: { onClose?: () => void; onSwitchToSignUp?: () => void }) => {
    ...
    <StyledWrapper>
      <form className="form" onSubmit={handleSubmit}>
        ...
        <div className="flex-row">
          ...
          <span className="span" onClick={() => setShowForgotPassword(true)} style={{ cursor: 'pointer' }}>
            Forgot password?
          </span>
        </div>
        ...
        <p className="p">
          ...
          <span className="span" onClick={onSwitchToSignUp} style={{ cursor: 'pointer' }}>
            Sign Up
          </span>
        </p>
        ...
        <div className="flex-row">
      	...
      	C318.115,0,375.068,22.126,419.404,58.936z" />
            ...
            Google 
          </button><button type="button" className="btn apple">
